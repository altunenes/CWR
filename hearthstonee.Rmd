...
After this basic filtering, now we can do some analysis. Our first question is "are there any connection between the mana costs and its' card designers" more clearly: Is there any particular pattern for Artists that contribute to the card design depends on the card's mana cost?
